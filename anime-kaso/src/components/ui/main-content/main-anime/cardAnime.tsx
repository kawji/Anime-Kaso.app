...
export default function CardAnime({ png ,title ,favorites }:Props) {
    const [isLoading ,setIsLoading] = useState(true);
    return(
        <article className="flex flex-1 grow shrink-1 min-h-[250px] min-w-[170px] max-w-[200px] w-full mx-auto rounded-lg overflow-hidden relative hover:shadow-2xl hover:shadow-[#232323)] group transition-all cursor-pointer" >
