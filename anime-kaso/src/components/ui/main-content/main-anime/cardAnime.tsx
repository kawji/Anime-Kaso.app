...
export default function CardAnime() {
    return(
        <article className="max-w-[220px] w-full h-auto mx-auto ml-[var(--start-left)] rounded-lg overflow-hidden relative hover:shadow-2xl hover:shadow-[#232323)] group transition-all cursor-pointer" >
