...
export default function CaptionCarousel({ title ,subtitles ,chapter }:guideAnimeDetailType) {
    return(
        <figcaption className="flex absolute right-0 bottom-0 sm:w-[75%] w-full h-auto py-0 bg-black/50 backdrop-blur-[4px] sm:rounded-tl-2xl shadow-lg shadow-blue-500 " >
