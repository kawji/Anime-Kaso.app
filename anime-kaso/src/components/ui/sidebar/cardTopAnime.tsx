...
export default function CardTopAnime({ title ,watch ,png }:Props) {
    return(
        <div className=" flex gap-2 rounded-lg group cursor-pointer mb-2 " >
            ...
            <div className="flex flex-col gap-3 w-full lg:w-18" >
                ...
                <span className="px-1 py-0.5 text-[13px] flex items-center justify-center border border-white/75 bg-[#212020] rounded-md gap-2 transition group-hover:text-white/70 " >
