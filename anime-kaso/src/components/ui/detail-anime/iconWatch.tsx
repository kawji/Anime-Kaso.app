...
export default function IconWatch({ tagIcon ,name ,url }:PropsIconWatch ) {

    return(
        <a className="shrink-0 group px-5 py-3 rounded-lg bg-[#141414] flex gap-3.5 cursor-pointer hover:bg-[#141414d5] transition-all hover:opacity-97  " href={url} target="_blank" >
