...
export default function Pagination() {
    ...
    return(
        <nav className="max-w-[70vw] lg:ml-[80px] sm:ml-[45px] ml-4 w-[88%] h-auto lg:h-15 gap-4 bg-[#161515] border-white/25 border flex items-center justify-center px-6 py-4 rounded-md  " >
