...
function FormAnime() {
    return(
        <div className="fixed flex w-full h-full bg-black/55 z-99 justify-center items-center ">
            ...
            <span className=" flex flex-col gap-[1px] w-full pb-5 mb-9 border-b border-b-white/10 ">
            ...
            <span className="flex flex-col pb-5  border-b border-b-white/10 mt-2">
                <h6 className=" text-lg text-white/88">
                    อัปเดตซีซั่น 
                </h6>
            ...
            <span className="flex flex-col pb-5  border-b border-b-white/10 mt-2">
                ...
                <p className=" text-md text-white/44 ">เพิ่มข้อมูลอนิเมะเกี่ยวกับเรื่องย่อของอนิเมะเรื่องนี้</p>
                <span className=" flex gap-3 mt-3">
                    <textarea placeholder="เขียนเรื่องย่อสักหน่อยสิ" className="outline-none appearance-none focus:outline-none focus:ring-2 focus:ring-gray-800/0
                     border border-white/50 rounded max-w-xl w-full  p-1.5 flex justify-center items-center pl-1.5 hover:border-white/75 transition-all  " />
