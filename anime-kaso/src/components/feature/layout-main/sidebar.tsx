...
export default function Sidebar() {
    ...
    return(
        <aside  className=" bg-[#131313] flex-1 p-5 lg:pb-0 lg:pl-10 flex flex-col gap-8 lg:gap-15 left-0 shrink-0 shadow-sm shadow-white/30 items-center lg:items-start w-full lg:w-[260px] lg:pt-[var(--start-top)] pl-[var(--start-left)] h-full  z-99 ">
            ...
            <div className="flex flex-col gap-5 lg:gap-0 flex-1 shrink-0 lg:pr-0.5 w-full items-start p-5 rounded-xl border border-white/20 lg:p-0 lg:border-none" >
